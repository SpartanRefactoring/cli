 ...
 * painting,cooking -o /tmp/output.txt -firstName Jane -path
...
public class Demo extends Base {
  ...
  private static void demonstratePropertiesProcessing() {
    @NotNull final SystemProperties s = new SystemProperties();
  ...
  private static void printResidue(@NotNull final Object[] os) {
  ...
  private static void printRemaining(@NotNull final List<String> remaining) {
